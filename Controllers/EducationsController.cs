...
namespace FieldP3_PersonalWebsite.Controllers
{
    public class EducationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EducationID,Degree,Start,End,School")] Education education)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EducationID,Degree,Start,End,School")] Education education)
        {
