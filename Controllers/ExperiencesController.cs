...
namespace FieldP3_PersonalWebsite.Controllers
{
    public class ExperiencesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ExperienceID,Title,Start,End,Description")] Experience experience)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ExperienceID,Title,Start,End,Description")] Experience experience)
        {
